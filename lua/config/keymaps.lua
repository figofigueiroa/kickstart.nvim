...
map('n', '<leader>xq', vim.diagnostic.setloclist, { desc = 'Open diagnostic Quickfi[X] list' })
-- location list
...
map('n', '<leader>T', '<cmd>terminal<CR>', { desc = 'Terminal (cwd)' })
...
map('n', '<leader>wq', '<C-W>c', { desc = 'Quit Window', remap = true })
