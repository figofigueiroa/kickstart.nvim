local java_filetypes = {".java", ".gradle", ".groovy", ".kt", ".kts", ".mvn", ".pom", ".properties"}

local has_mason = require("lazy.core.config").plugins["mason"] ~= nil
local has_dap = require("lazy.core.config").plugins["nvim-dap"] ~= nil
