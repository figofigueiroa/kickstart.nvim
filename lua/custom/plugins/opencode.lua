-- OpenCode is only available on Linux; skip entirely on Windows.
...
-- Must be set before the plugin loads (keymaps trigger the actual require).
---@type opencode.Opts
vim.g.opencode_opts = {
  -- Your configuration, if any; goto definition on the type for details
}

-- Keymaps use require() lazily — opencode only loads when a keymap fires.
